...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "training" / "reports" / "attack_opportunity_baseline"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the first attack-opportunity baseline model.")
...
def main() -> int:
    ...
    target_column = "attack_opportunity_proxy_label"
    ...
    model_path = args.output_dir / "attack_opportunity_model_baseline.txt"
    summary_path = args.output_dir / "attack_opportunity_baseline_report.json"
    ...
    summary = {
        ...
        "label_source": "attack_opportunity_proxy_label",
